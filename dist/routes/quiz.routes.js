...
router.get("/courses/:id/questions", (0, validation_middleware_1.validateParams)(validators_1.courseIdParamSchema), (0, validation_middleware_1.validateQuery)(question_validator_1.questionQuerySchema), question_1.questionController.getCourseQuestions);
router.post("/courses/:id/questions", auth_middleware_1.requireAdmin, (0, validation_middleware_1.validateParams)(validators_1.courseIdParamSchema), (0, validation_middleware_1.validateBody)(question_validator_1.createQuestionSchema), question_1.questionController.createQuestion);
router.get("/courses/:id/questions/stats", auth_middleware_1.requireAdmin, (0, validation_middleware_1.validateParams)(validators_1.courseIdParamSchema), question_1.questionController.getCourseQuestionStats);
